...
import '../styles/produitmanga.css';
...
function ProduitManga() {
  ...
  return (
    <div className='produitall'>
      ...
      <p className='produit3' data-label='description'>: {manga.description}</p>
      <p className='produit4' data-label='Publication Date'>: {manga.publication_date}</p>
    </div>
  );
